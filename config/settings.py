...
SECRET_KEY = 'django-insecure-e#fhiwscv3zp+x(px(*f8&5hav+^xk*=29s)lvywwwrj(1^fmd'
...
# Expira a sessão em 15 minutos (900 segundos) de inatividade
SESSION_COOKIE_AGE = 900 

# A cada requisição, reseta o contador (se o usuário estiver mexendo, não cai)
